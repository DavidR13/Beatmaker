class DrumKit {
    ...
    // add/remove active class if a pad is clicked
    activePad() {
        this.classList.toggle("active");
    }

    // helps with the loop and plays audio if pads are active
    repeat() {
    ...
    // start looping if play button is clicked
    start() {
    ...
    // change audio source based on selected value
    changeSound(event) {
    ...
    // mute audio if the mute button is clicked
    mute(event) {
